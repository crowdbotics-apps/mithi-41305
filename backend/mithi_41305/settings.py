"""
Django settings for mithi_41305 project.
...
WSGI_APPLICATION = 'mithi_41305.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithi_41305 API",
    "DESCRIPTION": "API documentation for mithi_41305 App",
    "VERSION": "v1",
}
